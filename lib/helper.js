...
UI.registerHelper("currentUser",function(){
    ...
    var services = userObj.services;
    if(services.hasOwnProperty("wechat")||services.hasOwnProperty("webwechat")){//微信用户
      if(Meteor.Device.isPhone()){
        //手机截取用户名前两位显示
        userObj.username = userObj.profile.nickname.substring(0,2)+"...";
      }else{
        userObj.username = userObj.profile.nickname;
      }
      var currentUser = {
        "_id" : userObj._id,
